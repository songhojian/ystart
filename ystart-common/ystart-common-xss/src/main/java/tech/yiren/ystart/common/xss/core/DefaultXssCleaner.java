...
package tech.yiren.ystart.common.xss.core;

import cn.hutool.core.util.CharsetUtil;
import tech.yiren.ystart.common.xss.config.YstartXssProperties;
import tech.yiren.ystart.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final YstartXssProperties properties;
	...
	public String clean(String bodyHtml) {
		...
		YstartXssProperties.Mode mode = properties.getMode();
		if (YstartXssProperties.Mode.escape == mode) {
			// html 转义
