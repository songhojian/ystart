 ...
 */
@Slf4j
public class YstartSentinelInvocationHandler implements InvocationHandler {
	...
	YstartSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			YstartSentinelInvocationHandler other = (YstartSentinelInvocationHandler) obj;
