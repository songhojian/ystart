package tech.yiren.ystart.auth.service;
...
import tech.yiren.ystart.admin.api.feign.RemoteClientDetailsService;
...
public class YstartClientDetailsServiceImpl implements ClientDetailsService {
